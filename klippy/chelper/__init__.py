...
SOURCE_FILES = [
    ...
    'kin_cartesian.c', 'kin_corexy.c', 'kin_delta.c', 'kin_hangprinter.c',
    'kin_extruder.c'
]
...
defs_kin_hangprinter = """
    struct stepper_kinematics *hangprinter_stepper_alloc(double anchor_x
...
defs_all = [
    ...
    defs_kin_cartesian, defs_kin_corexy, defs_kin_delta, defs_kin_hangprinter,
    defs_kin_extruder
]
