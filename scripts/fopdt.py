...
def plot_data(gbt, outname):
    ...
    ax1.plot(times, fopdt_temps, 'b', label='fopdt', alpha=0.3)
    ax1.plot(times, smoothed_temps, 'r', label='smoothed fopdt', alpha=0.8)
    ax1.plot(times, measured_temps, 'g', label='measured', alpha=0.8)
